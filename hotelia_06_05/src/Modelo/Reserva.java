...
public class Reserva {
    int idReserva, idFactura, cantidad_personas;
    Integer idServicio, idHabitacion;
    String idCliente, estado;
    Date fecha_inicio, fecha_fin, fecha_hora_reserva;

    public Reserva(Integer idServicio, Integer idHabitacion, int idFactura, int cantidad_personas, String idCliente, String estado, Date fecha_inicio, Date fecha_fin, Date fecha_hora_reserva) {
