 ...
 * @author DAM2Alu3
 */
public class JFrame1LaFdefecto extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(JFrame1LaFdefecto.class.getName());
    ...
    private void jComboBoxLookandFeelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxLookandFeelActionPerformed
        ...
        UIManager.LookAndFeelInfo lafi = UIManager.getInstalledLookAndFeels()[
                jComboBoxLookandFeel.getSelectedIndex()];  
        ...
        try {
            ...
            System.getLogger(JFrame1LaFdefecto.class.getName()).log(System.Logger.Level.ERROR, (String) null, ex);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new JFrame1LaFdefecto().setVisible(true));
    }
