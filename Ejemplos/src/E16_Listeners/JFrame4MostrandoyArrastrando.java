...
public class JFrame4MostrandoyArrastrando extends javax.swing.JFrame {
    ...
    public JFrame4MostrandoyArrastrando() {
        ...
        KeyStroke ctrl_C = KeyStroke.getKeyStroke(KeyEvent.VK_C,
                java.awt.Event.CTRL_MASK, 
                true);
        getRootPane().registerKeyboardAction(aL,
                    ctrl_C ,
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pasa el raton por encima");

        jPanelOculto.setBackground(new java.awt.Color(102, 255, 102));
    ...
    private void jButton1MouseDragged(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseDragged
        // TODO add your handling code here:
        jButton1.setBounds(evt.getX(), evt.getY(), 100, 30);
